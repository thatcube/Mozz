...
@Suite struct WireFixtureConformanceTests {
    ...
    @Test func everyDeclaredCommandIsAccountedFor() throws {
        ...
        case .artwork: name = "artwork"
        case .enqueueDownload: name = "enqueueDownload"
        case .reportDownloadProgress: name = "reportDownloadProgress"
        case .completeDownload: name = "completeDownload"
        case .failDownload: name = "failDownload"
        case .cancelDownload: name = "cancelDownload"
        case .deleteDownload: name = "deleteDownload"
        case .downloadStatus: name = "downloadStatus"
        case .downloads: name = "downloads"
        case .storageUsage: name = "storageUsage"
        case .lyrics: name = "lyrics"
        case .recordingIdentity: name = "recordingIdentity"
        case .similarTracks: name = "similarTracks"
        case .playbackPlay: name = "playbackPlay"
        case .playbackQueueNext: name = "playbackQueueNext"
        case .playbackPause: name = "playbackPause"
        case .playbackResume: name = "playbackResume"
        case .playbackStop: name = "playbackStop"
        case .playbackSeek: name = "playbackSeek"
        case .playbackSetVolume: name = "playbackSetVolume"
        case .playbackSetEqualizer: name = "playbackSetEqualizer"
        case .playbackSetReplayGain: name = "playbackSetReplayGain"
        case .playbackState: name = "playbackState"
